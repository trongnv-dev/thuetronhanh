                ...
                <div class="col-12">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Danh sách báo cáo từ người dùng <span
                                    class="badge badge-primary">{{ $reports }}</span></h5>
                        </div>
                                ...
                                @foreach($room->reports as $report)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ time_elapsed_string($report->created_at) }} <span
                                                class="badge badge-primary">{{ $report->created_at }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            @endforeach

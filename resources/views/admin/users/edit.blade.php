    ...
    <div class="content-wrapper">
        ...
        <div class="content">
                    ...
                    <div class="content-group border-top-lg border-top-primary">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                Nếu bạn không muốn thay đổi <code>Mật khẩu</code> thì hãy để trống 2 trường nhập giá trị
                                mật khẩu.
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" readonly="" name="username"
                                                           ...
                                                           placeholder="username lớn hơn 4 kí tự">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="icon-git-pull-request"></i></span>
                                                    <input type="text" value="{{$user->name}}" name="HoTen"
                                                           class="form-control" placeholder="Nhập đầy đủ họ tên">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" value="" name="password"
                                                           ...
                                                           placeholder="Mật khẩu lớn hơn 3 và nhỏ hơn 32 kí tự">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="content-group border-top-lg border-top-danger">
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                <span
                                    class="badge badge-primary">Bỏ trống 2 trường giá trị mật khẩu nếu không thay đổi</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer text-muted">
                &copy; 2019. <a href="{{ route('index') }}" target="_blank">Thuê Trọ Nhanh - Website đăng tin, tìm kiếm
                    trọ hàng đầu miền trung</a> by <a href="https://www.facebook.com/trongnv6" target="_blank">Nguyễn
                    Trọng</a>
            </div>
            <!-- /footer -->
        </div>

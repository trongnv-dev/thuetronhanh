                            ...
                            <form action="{{ route ('user.dangtin') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="location-text-box" name="txtaddress" class="form-control"
                                           value=""/>
                                    {{--                            <textarea name="txtaddress" class="form-control" id="location-text-box" rows="1" autosuggest="off" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>--}}

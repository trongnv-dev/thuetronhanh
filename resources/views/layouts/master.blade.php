			...
			<div class="row">
				<div class="col-md-4">
					<div class="logo-footer">
						<a href="/" title="Thuê Trọ Nhanh - Website đăng tin, tìm kiếm trọ hàng đầu miền trung">
							<img src="/images/logo.png">
						</a>
						<div style="padding-top: 10px;">
							<p>Thuê Trọ Nhanh - Website đăng tin, tìm kiếm trọ hàng đầu miền trung</p>
							<p>Liên hệ quảng cáo: 0936234523</p>
                            <p>Email: trongnv.dev@gmail.com</p>
						</div>
					</div>
				</div>
                <div class="col-md-4">
                    <div class="logo-footer">
                        ...
                        <div style="padding-top: 10px;">
                            <p>Thuê Trọ Nhanh - Website đăng tin, tìm kiếm trọ hàng đầu miền trung</p>
                            <p>Liên hệ: 0936234523</p>
                            <p>Email: trongnv.dev@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="logo-footer linked-website">
                        <a href="/" title="Thuê Trọ Nhanh - Website đăng tin, tìm kiếm trọ hàng đầu miền trung">
                            <img src="/images/logo.png">
                        </a>
                        <div style="padding-top: 10px;">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <a href="https://ngockhuong.com">Ngọc Khương IT</a>
                                </li>
                                <li class="list-group-item">
                                    <a href="https://itphutran.com">IT Phú Trần</a>
                                </li>
                            </ul>
                        </div>
                    </div>
